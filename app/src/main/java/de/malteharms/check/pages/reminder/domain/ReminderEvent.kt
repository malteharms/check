...
sealed interface ReminderEvent {
    ...
    data class UpdateItem(val itemToUpdate: de.malteharms.database.tables.ReminderItem): ReminderEvent
    ...
    data class SetCategory(val category: de.malteharms.database.tables.ReminderCategory): ReminderEvent

    data class AddDummyNotification(val value: Int, val timeUnit: ChronoUnit): ReminderEvent
    data class RemoveNotification(val notification: de.malteharms.database.tables.NotificationItem): ReminderEvent
    ...
    data class AddOrRemoveFilterCategory(val filter: de.malteharms.database.tables.ReminderCategory): ReminderEvent
}
